...
import mision1 from "../../assets/mision-1.png";
import mision2 from "../../assets/mision-2.png";
    ...
    return (
        ...
        <div className="mision-content">
            ...
            <div className="two-columns">
                ...
                <img className="mision-img" src={mision1} alt="" /> 
            ...
            <p className="mision-title2">Transparencia</p>
            <div className="two-columns">
            <img className="mision-img2" src={mision2} alt="" />
                <p className="transparencia">
                El Observatorio de Datos con perspectiva de género es una organización
                de la sociedad civil independiente y apartidaria que se financia con aportes de sus integrantes.
                </p>
